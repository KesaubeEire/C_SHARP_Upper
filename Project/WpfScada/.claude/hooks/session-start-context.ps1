...
# so every session leads with the product vision, not the tech. Edit that .md to
# change what's injected — this script just relays it.
#
# Fails OPEN (emits nothing) on any problem.
