...
// 批量注册
services.AddTransientFromNamespace("WpfScada.Views", GalleryAssembly.Asssembly);
services.AddTransientFromNamespace("WpfScada.ViewModels", GalleryAssembly.Asssembly);
```
...
private static readonly IHost _host = Host.CreateDefaultBuilder()
    .ConfigureServices((_, services) =>
    {
        ...
        // 批量：自动发现
        services.AddTransientFromNamespace("WpfScada.Views", Assembly.Asssembly);
    })
    .Build();
```
